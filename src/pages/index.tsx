  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Explorere - Your ultimate car rental platform, tailored to empower customers, salespeople, and administrators alike."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Explorere - Your ultimate car rental platform, tailored to empower customers, salespeople, and administrators alike.`}
            </Text>
            <Box
